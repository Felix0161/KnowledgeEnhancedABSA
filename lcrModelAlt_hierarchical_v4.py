...
def main(train_path, test_path, accuracyOnt, test_size, remaining_size, emb_path=FLAGS.embedding_path, learning_rate=0.09, keep_prob=0.3, momentum=0.85, l2=0.00001):
    print_config()
    with tf.device('/gpu:1'):
        word_id_mapping, w2v = load_w2v(emb_path, FLAGS.embedding_dim)
